"""
Dataset B Training: CNN-LSTM for Normal vs Uncertain MI
Training on pure_normal + uncertain_mi (MI with prob<100%)
"""
...
def main():
    print(f"\n{'='*60}")
    print("CNN-LSTM TRAINING - DATASET B (Uncertain MI)")
    print(f"{'='*60}")
    ...
    with open('../results/metrics/training_summary.txt', 'w') as f:
        f.write("CNN-LSTM Training Summary - Dataset B\n")
        f.write("="*60 + "\n\n")
