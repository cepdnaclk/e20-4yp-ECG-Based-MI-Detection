...
Analyzes prediction calibration for Datasets A and C only
...
def plot_precision_recall_curve(datasets_dict, save_path):
    ...
    ax.set_title('Precision-Recall Curves: Dataset A vs C', 
...
def plot_calibration_curve(datasets_dict, save_path, n_bins=10):
    ...
    ax.set_title('Calibration Curves: Dataset A vs C', 
                fontsize=14, fontweight='bold')
...
def plot_reliability_diagram(datasets_dict, save_path, n_bins=10):
    ...
    colors = {'A': '#e74c3c', 'C': '#3498db'}
    titles = {'A': 'Dataset A (Certain MI)', 'C': 'Dataset C (All MI)'}
...
def main():
    ...
    print("Datasets A (Certain MI) vs C (All MI)")
    ...
    print("\n[Step 1] Loading predictions from datasets A and C...")
    ...
    # Save results
    results_df.to_csv('calibration_metrics_A_vs_C.csv', index=False)
    print(f"\n✅ Saved: calibration_metrics_A_vs_C.csv")
    ...
    plot_precision_recall_curve(datasets, 'precision_recall_curves_A_vs_C.png')
    
    # Calibration Curves
    plot_calibration_curve(datasets, 'calibration_curves_A_vs_C.png', n_bins=10)
    
    # Reliability Diagrams
    plot_reliability_diagram(datasets, 'reliability_diagrams_A_vs_C.png', n_bins=10)
    
    # Decile Calibration
    plot_decile_calibration(datasets, 'decile_calibration_A_vs_C.png')
    ...
    print(f"{'='*70}")
    print(f"\n📁 Files Generated:")
    print(f"  • calibration_metrics_A_vs_C.csv")
    print(f"  • precision_recall_curves_A_vs_C.png")
    print(f"  • calibration_curves_A_vs_C.png")
    print(f"  • reliability_diagrams_A_vs_C.png")
    print(f"  • decile_calibration_A_vs_C.png")
    print(f"\n{'='*70}\n")
