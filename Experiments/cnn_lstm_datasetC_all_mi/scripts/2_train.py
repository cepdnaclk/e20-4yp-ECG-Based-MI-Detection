"""
Dataset C Training: CNN-LSTM for Normal vs All MI
Training on pure_normal + certain_mi + uncertain_mi (all MI cases)
"""
...
def main():
    print(f"\n{'='*60}")
    print("CNN-LSTM TRAINING - DATASET C (All MI)")
    print(f"{'='*60}")
    ...
    with open('../results/metrics/training_summary.txt', 'w') as f:
        f.write("CNN-LSTM Training Summary - Dataset C\n")
        f.write("="*60 + "\n\n")
